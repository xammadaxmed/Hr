...
public partial class emplyee_EmpAppraisal05 : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand myCommand = new SqlCommand("insert into EmpAppraisalRector Values ('" + Convert.ToString(Session["id"]) + "','" + this.txtEmpJustification.Text + "','" +"Rector" + "','" + this.lblEmpDate.Text + "')", myConnection);
        myConnection.Open();
