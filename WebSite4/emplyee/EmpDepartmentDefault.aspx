<%@ Page Title="" Language="C#" MasterPageFile="~/emplyee/empadmin.master" AutoEventWireup="true" CodeFile="EmpDepartmentDefault.aspx.cs" Inherits="emplyee_EmpDepartmentDefault" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style2">
        <tr>
								<TD align="center" style="font-family: arial; font-size: medium; font-weight: 700; background-color: #3399FF;">
						<asp:Image id="Image1" runat="server" ImageUrl="~/pictures\department.jpg"></asp:Image></TD>
							</tr>
        <tr>
								<TD align="center" style="font-family: arial; font-size: medium; font-weight: 700; background-color: #3399FF;">
        ...
        <tr>
								<TD align="center" style="font-family: arial; font-size: medium; height: 30px;"><strong>Enter New Department ID and Name</strong></TD>
							</tr>
        <tr>
            <td style="height: 70px">
									<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0" align="center" style="width: 357px">
										<TR>
											<TD style="font-family: arial; font-size: 12px;"><b>Department Name</b></TD>
											<TD style="text-align: center">
