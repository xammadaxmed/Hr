<%@ Page Title="" Language="C#" MasterPageFile="~/emplyee/empadmin.master" AutoEventWireup="true" CodeFile="EmpContract.aspx.cs" Inherits="emplyee_EmpContract" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style2">
        <tr>
            <td>
						<asp:Image id="Image2" runat="server" ImageUrl="~/pictures\employee contract details.jpg"></asp:Image></td>
        </tr>
        <tr>
            ...
            <td>
										<TABLE id="Table3" style="WIDTH: 340px; HEIGHT: 445px" cellSpacing="1" cellPadding="1"
											...
											<TD  style="text-align: center; background-color: #FFFFFF; width: 218px; height: 70px;">
                                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="username" DataValueField="EmpID" Height="16px" Width="160px">
                                                </asp:DropDownList>
